...
var inquirerToPackage = function (inquirerPkg, resp) {
  ...
  inquirerPkg.forEach(function (it) {
    if (Object.prototype.hasOwnProperty.call(it, 'package')) {
      if (Object.prototype.hasOwnProperty.call(it, 'subPackages')) {
    ...
    } else if (Object.prototype.hasOwnProperty.call(it, 'fileType')) {
      packageDef.data = {};
      packageDef.data.get = {};
      packageDef.data.get.uri = it.uri || '';
      packageDef.data.get.mirrors = it.mirrors || [];
      packageDef.data.get.ref = it.uriRef || '';
      if (!packageDef.data.get.$ref) {
        packageDef.data.get.$ref = '';
      }
    ...
    } else if (Object.prototype.hasOwnProperty.call(it, 'key0')) {
    ...
    } else if (Object.prototype.hasOwnProperty.call(it, 'key1')) {
      ...
      if (Object.prototype.hasOwnProperty.call(it, 'dependency/install')) {
        depName = 'dependency/install';
      } else if (Object.prototype.hasOwnProperty.call(it, 'dependency/build')) {
        depName = 'dependency/build';
      } else if (Object.prototype.hasOwnProperty.call(it, 'dependency/make')) {
  ...
  async.parallel(
    [
      ...
      function (callback) {
        ...
        /* Remove unstaged changes now that it's integrated into the base config file */
        def.removeUnstage(packageDef, resp);
