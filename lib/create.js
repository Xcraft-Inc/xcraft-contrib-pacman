...
var inquirerToPackage = function (pkgRepository, inquirerPkg) {
  ...
  inquirerPkg.forEach (function (it) {
    if (it.hasOwnProperty ('package')) {
      ...
      if (!util.isArray (packageDef.dependency.runtime[it.dependency])) {
        packageDef.dependency.runtime[it.dependency] = [];
      }
      packageDef.dependency.runtime[it.dependency].push (it.version);
