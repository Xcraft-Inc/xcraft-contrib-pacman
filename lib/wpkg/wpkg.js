...
const moduleName = 'pacman/wpkg';

const path = require ('path');
const fs   = require ('fs');

const xLog         = require ('xcraft-core-log') (moduleName);
const xCMake       = require ('xctaft-contrib-bootcmake');
...
const WpkgBin = require ('./wpkgbin.js');
...
// FIXME: extract this code in toolchain+xcraft-peon
const internalConfigure = function (fileList, arch) {
  const root = path.join (xcraftConfig.pkgTargetRoot, arch);
