      ...
      var fctValue = function (it) {
        ...
        case 'dependency': {
          ...
          Object.keys (packageDef[it].install).forEach (function (dep) {
            packageDef[it].install[dep].forEach (function (version) {
 ...
 */
exports.controlFiles = function (packageName, packageArch, packageDef, saveFiles) {
  if (saveFiles) {
  ...
  Object.keys (control).forEach (function (arch) {
    if (!utils.checkOsSupport (packageName, packageArch, packageDef, arch)) {
      return;
    }
