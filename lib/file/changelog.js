 ...
 */
exports.changelogFiles = function (packageArch, packageDef, response) {
  ...
  packageDef.architecture.forEach (function (arch) {
    ...
    if (fs.existsSync (fileOut)) {
      response.log.warn ('the ChangeLog file will be overwritten: ' + fileOut);
    }
    ...
    ph.set ('NAME',             packageDef.name)
      ...
      .set ('DISTRIBUTION',     packageDef.distribution)
