 ...
 */
exports.etcFiles = function (packageArch, packageDef, resp) {
  ...
  packageDef.architecture.forEach(function (arch) {
    ...
    Object.keys(packageDef.data.env)
      ...
      .forEach((key) => {
        ...
        resp.log.verb(util.format(`Config file for ${key}:\n%s`, data));
        ...
        if (fs.existsSync(fileOut)) {
          resp.log.warn('the config file will be overwritten: ' + fileOut);
        }
