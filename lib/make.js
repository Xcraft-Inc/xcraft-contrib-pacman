...
var nextFile = function (files, packageDef, callback) {
  ...
  var wpkgBuild = function (packageDef, callback) {
    ...
    wpkg[action] (packagePath, packageDef.distribution, function (err) {
      ...
      if (!files.length) {
        ...
        nextFile (files, packageDef, callback);
      }
    });
  };
